...
from src.evaluator.ctc_evaluator import CTCEvaluator
...
def build_eval_config(cfg_dict, device, worker_id, worker_log_root,
    ...
    return {
        ...
        'kc': cfg_dict.get("kc", 50),
        'ctc_delta': cfg_dict.get("ctc_delta", 5),
        'ctc_threshold': cfg_dict.get("ctc_threshold", 0.5),
        'test_num': chunk_size,
    }


def main():
    cfg = OmegaConf.load('configs/test/test_ctc.yaml')
