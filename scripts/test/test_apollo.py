...
from src.utils.parallel_runner import run_parallel_eval, merge_apollo_metrics
...
def build_eval_config(cfg_dict, device, worker_id, worker_log_root, worker_result_root, worker_scores_root, chunk_size):
    return {
        ...
        'k0_list': cfg_dict["k0_list"],
        'k1_list': cfg_dict["k1_list"],
        'delta_list': cfg_dict["delta_list"],
...
def main():
    ...
    run_parallel_eval(
        cfg_dict=cfg_dict,
        instances=instances,
        evaluator_cls=ApolloEvaluator,
        build_model_fn=build_model,
        build_eval_config_fn=build_eval_config,
        merge_fn=merge_apollo_metrics,
    )
